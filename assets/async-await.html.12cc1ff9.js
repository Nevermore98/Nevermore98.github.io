...
</code></pre></div>`,1);function m(f,y){const a=u("ExternalLinkIcon");return p(),o("div",null,[k,n("p",null,[n("a",i,[r,c(a)])]),d])}var h=t(l,[["render",m],["__file","async-await.html.vue"]]);export{h as default};
