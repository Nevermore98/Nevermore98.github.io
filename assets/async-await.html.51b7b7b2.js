...
</code></pre></div><h2 id="async\u3001await-\u52A0\u8F7D\u56FE\u7247" tabindex="-1"><a class="header-anchor" href="#async\u3001await-\u52A0\u8F7D\u56FE\u7247" aria-hidden="true">#</a> async\u3001await \u52A0\u8F7D\u56FE\u7247</h2>`,23),i={href:"http://js.jirengu.com/jaxurotole/1/edit?js,output",target:"_blank",rel:"noopener noreferrer"},r=u("\u5728\u7EBF\u9884\u89C8"),d=s(`<div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">loadImg</span><span class="token punctuation">(</span><span class="token parameter">src</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div>`,1);function m(y,f){const a=p("ExternalLinkIcon");return o(),c("div",null,[k,n("p",null,[n("a",i,[r,e(a)])]),d])}var v=t(l,[["render",m],["__file","async-await.html.vue"]]);export{v as default};
